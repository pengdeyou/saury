...
final public class Constant {
	...
	/**
	 * Set ITokenCache implementation otherwise Saury will use the HttpSesion to hold the token.
	...
	public void setBaseViewPath(String baseViewPath) {
		RouterFactory.setBaseViewPath(baseViewPath);
	}
