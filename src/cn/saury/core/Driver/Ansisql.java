...
import cn.saury.core.Activerecord.CPI;
import cn.saury.core.Activerecord.DbKit;
import cn.saury.core.Activerecord.Model;
import cn.saury.core.Activerecord.ModelBuilder;
 ...
 */
public class Ansisql extends Abstract {
	...
	public Pager<? extends Model> takeOverModelPaginate(Class<? extends Model> modelClass, int pageNumber, int pageSize, String select, String sqlExceptSelect, Object... paras) {
		...
		try {
			...
			if (size == 1)
				...
				return new Pager(new ArrayList(0), pageNumber, pageSize, 0, 0);	// totalRow = 0;
			...
			if (rs != null) rs.close();
			if (pst != null) pst.close();
			return new Pager(list, pageNumber, pageSize, totalPage, (int)totalRow);
		} catch (Exception e) {
