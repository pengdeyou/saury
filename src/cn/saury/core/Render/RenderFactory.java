...
import cn.saury.core.Constant;
import cn.saury.core.Helper.PathKit;

import static cn.saury.core.Const.DEFAULT_FILE_RENDER_BASE_PATH;
...
public class RenderFactory {
	...
	public void init(Constant constants, ServletContext servletContext) {
	...
	/**
	 * Return Render by default ViewType which config in SauryConfig
	 */
