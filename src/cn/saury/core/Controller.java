...
import static cn.saury.core.Const.I18N_LOCALE;

import cn.saury.core.Helper.StringKit;
import cn.saury.core.Helper.Uploader.MultipartRequest;
import cn.saury.core.Helper.Uploader.UploadFile;
...
public abstract class Controller {
	...
	public void createToken(String tokenName, int secondsOfTimeOut) {
		cn.saury.core.Helper.Token.TokenManager.createToken(this, tokenName, secondsOfTimeOut);
	}
	...
	public boolean validateToken(String tokenName) {
		return cn.saury.core.Helper.Token.TokenManager.validateToken(this, tokenName);
	}
	...
	/**
	 * Render with view use default type Render configured in SauryConfig
	 */
	 ...
	 * <p>
	 * Example: renderJson(new User().set("name", "Saury").set("age", 18));
	 */
	...
	/**
	 * Render with view and status use default type Render configured in SauryConfig
	 */
	...
	public void renderError404(String view) {
		throw new cn.saury.core.Render.Error404Exception(renderFactory.getError404Render(view));
	}
	
	/**
	 * Render with view and 404 status configured in SauryConfig
	 */
	public void renderError404() {
		throw new cn.saury.core.Render.Error404Exception(renderFactory.getError404Render());
	}
	...
	public void renderError500(String view) {
		throw new cn.saury.core.Render.Error500Exception(renderFactory.getError500Render(view));
	}
	
	/**
	 * Render with view and 500 status configured in SauryConfig
	 */
	public void renderError500() {
		throw new cn.saury.core.Render.Error500Exception(renderFactory.getError500Render());
	}
